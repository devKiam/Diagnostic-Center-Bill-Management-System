<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="test-wise-report.aspx.cs" Inherits="Mid_Term_WebApplicaiton.Test_Wise_Report_WebForm" %>
            ...
            <div class="table">
                <asp:GridView ID="testWiseReportGridView" AutoGenerateColumns="False" CssClass="gridView" runat="server">
                    <Columns>
                        ...
                        <asp:BoundField ItemStyle-Width="150px" DataField="no_of_test" ItemStyle-HorizontalAlign="Center" HeaderText="No Of Test" />
                        <asp:BoundField ItemStyle-Width="150px" DataField="total_amount" ItemStyle-HorizontalAlign="Center" HeaderText="Total Amount" />
                    </Columns>
                </asp:GridView>
            </div>
